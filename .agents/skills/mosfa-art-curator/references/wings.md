...
- **The Functional Reef**: A Modernist Tank design gallery for Bauhaus, industrial design, typographic systems, civic architecture, furniture, tools, and utility objects.
- **Reef War II Poster Gallery**: A Comic & Mass Culture Pavilion / poster-archive program for home-front propaganda, defense recruitment, labor, bonds, civil defense, and wartime public imagery.
...
- A Bauhaus-like design object or typographic study belongs in Modernist Tank, usually under The Functional Reef as a sub-gallery concept rather than a separate core wing.
- A Reef War II poster belongs in Comic & Mass Culture Pavilion unless its dominant visual language is socialist modernism, in which case Modernist Tank may be more appropriate.
